// microbenchmark/fc_sink_native.c
// Native 对照 - 数据消费者，读 stdin，校验并统计，rdcycle 测管道吞吐时间
#include <unistd.h>
#include <stdio.h>
#include "cycle.h"
...
int main(void) {
    ...
    fprintf(stderr, "[native-sink] received=%zd bytes, checksum=%ld, time=%.1f ms, bw=%.1f KB/s\n",
